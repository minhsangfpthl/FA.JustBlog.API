...
namespace FA.JustBlog.Services.BaseServices
{
    public class BaseService<TEntity> : IBaseService<TEntity> where TEntity : BaseEntity
    {
        ...
        public virtual IEnumerable<TEntity> GetAll(bool isIncludeDeleted = false)
        {
        ...
        public virtual async Task<IEnumerable<TEntity>> GetAllAsync(bool isIncludeDeleted = false)
        {
            if (isIncludeDeleted == false)
            {
